...
- [一、选题背景与设计思想](#一选题背景与设计思想20-分)
  - [1.1 问题定义](#11-问题定义)
  - [1.2 现有方案不足](#12-现有方案不足)
  - [1.3 项目价值](#13-项目价值)
  - [1.4 技术路线](#14-技术路线)
- [二、Specs 规格文档](#二specs-规格文档20-分)
  - [2.1 SDD 在本项目的落地方法](#21-sdd-在本项目的落地方法)
  - [2.2 Product Spec — 产品规格](#22-product-spec--产品规格)
    - [2.2.1 一句话定位](#221-一句话定位)
    - [2.2.2 用户与场景](#222-用户与场景)
    - [2.2.3 核心用户故事](#223-核心用户故事)
    - [2.2.4 非目标（Non-Goals）](#224-非目标non-goals)
    - [2.2.5 系统范围](#225-系统范围)
    - [2.2.6 关键质量属性](#226-关键质量属性)
    - [2.2.7 验收基线（Demo Day Checklist）](#227-验收基线demo-day-checklist)
  - [2.3 Architecture Spec — 架构规格](#23-architecture-spec--架构规格)
    - [2.3.1 设计原则](#231-设计原则)
    - [2.3.2 组件分层](#232-组件分层)
    - [2.3.3 Agent 拓扑](#233-agent-拓扑)
    - [2.3.4 State 模型](#234-state-模型)
    - [2.3.5 部署视图](#235-部署视图)
    - [2.3.6 不变量与失败模式](#236-不变量与失败模式)
  - [2.4 API Spec — 接口规格](#24-api-spec--接口规格)
    - [2.4.1 CLI 命令](#241-cli-命令)
    - [2.4.2 Agent 工具集（Function Calling）](#242-agent-工具集function-calling)
    - [2.4.3 核心数据结构](#243-核心数据结构)
    - [2.4.4 配置（环境变量）](#244-配置环境变量)
    - [2.4.5 错误协议](#245-错误协议)
- [三、系统架构与设计](#三系统架构与设计15-分)
  - [3.1 系统上下文](#31-系统上下文)
  - [3.2 核心架构图](#32-核心架构图)
  - [3.3 Agent 状态机](#33-agent-状态机)
  - [3.4 数据流时序](#34-数据流时序)
  - [3.5 关键架构决策（ADR 摘要）](#35-关键架构决策adr-摘要)
- [四、关键实现与代码展示](#四关键实现与代码展示15-分)
...
![image-20260618205839319](C:\Users\HQ\AppData\Roaming\Typora\typora-user-images\image-20260618205839319.png)
...
![image-20260618203949651](C:\Users\HQ\AppData\Roaming\Typora\typora-user-images\image-20260618203949651.png)
